...
class GenerateContentWithIaFromPostUrlJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle(): void
    {
        $prompt =
            ...
            "Gere um conteúdo otimizado para SEO com base na notícia extraída da primeira tag article.\n\n" .
            "---\n" .
            ...
            "Remova do conteúdo os links do site https://folha.qconcursos.com/, mantendo a palavra que estava com o link.\n" .
            "Mantenha links externos relacionados a editais link links de inscrição.\n" .
