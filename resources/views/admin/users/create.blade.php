...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="document_number">{{ trans('cruds.user.fields.document_number') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.document_number_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="birthday_at">{{ trans('cruds.user.fields.birthday_at') }}</label>
                <input class="form-control date {{ $errors->has('birthday_at') ? 'is-invalid' : '' }}" type="text" name="birthday_at" id="birthday_at" value="{{ old('birthday_at') }}">
                @if($errors->has('birthday_at'))
                    <div class="invalid-feedback">
                        {{ $errors->first('birthday_at') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.birthday_at_helper') }}</span>
            </div>
            <div class="form-group">
